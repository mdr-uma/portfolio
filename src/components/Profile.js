                ...
                <div className="col-md-6">
                    <div className="intro">
                        ...
                        <a href="https://twitter.com/imoohma">
                            <i className="fab fa-twitter-square shadow animate__animated animate__bounceInDown" id="twitter"></i>
                        </a>   
                        <a href=" https://github.com/mdr-uma">
                            <i className="fab fa-github-square shadow animate__animated animate__bounceInDown" id="git"></i>
                        </a>
                        <a href="https://www.linkedin.com/in/uma-manandhar">
                            <i className="fab fa-linkedin shadow animate__animated animate__bounceInDown" id="linkedin"></i>
                        </a>
                    </div >
